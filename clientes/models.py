...
class Cliente(models.Model):
    ...
    tipo_documento = models.CharField('Tipo de documento', max_length=10, choices=TIPO_DOCUMENTO_CHOICES)
    ...
    ciudad_id = models.IntegerField('Ciudad (id)', blank=True, null=True)
