    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documento', models.CharField(help_text='Documento de identidad (6-10 dígitos)', max_length=10, unique=True, validators=[django.core.validators.RegexValidator('^\\d{6,10}$', message='El documento debe tener entre 6 y 10 dígitos.')])),
                ('email', models.EmailField(blank=True, default='', max_length=254, unique=True, verbose_name='correo electrónico')),
