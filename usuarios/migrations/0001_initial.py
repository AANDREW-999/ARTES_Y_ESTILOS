    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documento', models.CharField(help_text='Documento de identidad (10 dígitos)', max_length=10, unique=True, validators=[django.core.validators.RegexValidator('^\\d{10}$', message='El documento debe tener exactamente 10 dígitos.')])),
